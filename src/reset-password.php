            ...
            <div class="grid grid-cols-2">
                <div class="col-span-2 p-3 sm:p-6">
                    ...
                    <form class="max-w-sm mx-auto" autocomplete="off">
                        <div class="mb-5" x-data="{ isShow: true }">
                            ...
                            <div class="relative">
                                ...
                                <button @click="isShow = !isShow" type="button" class="password-type-toggler | absolute right-0 top-0 h-full px-2 text-gray-400">
                                    <i class="fas fa-eye" x-show="!isShow"></i>
                                    <i class="fas fa-eye-slash" x-show="isShow"></i>
                                </button>
                            </div>
                        </div>
                        <div class="mb-5">
