        ...
        <div class="sm:flex items-center justify-between gap-8">
            ...
            <div class="flex items-center justify-between gap-4 mt-2 sm:mt-0">
                ...
                <div class="font-semibold flex items-center">
                    ...
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="flex items-center" type="button">
                        My Account
                    ...
                    <div id="dropdown" class="z-50 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                            ...
                            <li>
                                <a href="#" class="block px-4 py-2 text-red-500 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sign out</a>
                            </li>
                        </ul>
                    </div>
                </div>
