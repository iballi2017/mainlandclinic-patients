...
<footer class="bg-secondary-500 text-accent-600">
                ...
                <form action="">
                    <div class="relative">
                        <button class="absolute inset-y-0 end-0 flex items-center pe-3.5">
                            ...
                            <img src="./assets/icons/icon-green-plane.svg" alt="" class="img-fluid">
                        </button>
    ...
    <hr class="border border-[#c3c3c3] my-4">

    <p class="mb-0 text-center text-accent-700 text-sm pb-2">Mainland clinic 2023</p>
</footer>