...
<div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    <div class="p-2 sm:p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="min-h-96 flex place-content-center flex-col">
            ...
            <p class="text-lg font-bold text-center">Application submited Successfully</p>
            <div class="my-2"></div>
            <a href="./" class="back-history-btn | block text-center text-primary-600 font-bold">Go Home</a>
        </div>
