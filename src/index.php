                    ...
                    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div class="grid grid-cols-12 justify-start">
                            <div class="col-span-12 sm:col-span-7 p-4" style="background: rgba(0, 0, 0, .4);">
                                ...
                                <a href="" class="bg-primary-500 text-white rounded md:py-3 md:px-5 ms-3 animated animate__slideInLeft">
                                    Read
                                    More
                                </a>
                            </div>
                    ...
                    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div class="grid grid-cols-12 justify-start">
                            ...
                            <div class="col-span-12 sm:col-span-7 p-4" style="background: rgba(0, 0, 0, .4);">
                                ...
                                <a href="" class="bg-primary-500 text-white rounded md:py-3 md:px-5 mr-3 animated animate__slideInLeft">
                                    Read
                                    More
                                </a>
                            </div>
