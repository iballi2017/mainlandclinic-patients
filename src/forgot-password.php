...
<div class="mx-auto my-16 flex items-center justify-center">
        ...
        <div class="block mx-auto bg-white border border-gray-200 rounded-lg overflow-hidden shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="grid grid-cols-2">
                <div class="col-span-2 p-8">
                    <h1 class="text-center font-bold text-2xl text-secondary-500 uppercase font-display">Forgot Password</h1>
                    <p class="text-center">Please enter the email address you registered with. We will send you a link</p>
                    <div class="my-8"></div>
                    <form class="" autocomplete="off">
                        <label for="email" class="font-semibold block mb-2 text-base text-gray-900 dark:text-white">Email Address</label>
